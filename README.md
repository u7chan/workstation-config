...
[![CI](https://github.com/u7chan/workstation-config/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/u7chan/workstation-config/actions/workflows/ci.yml)
